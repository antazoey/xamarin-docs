...
style cards or voice input.

#### Companion Applications

Another strategy is to create a complete application that runs natively
on the wearable device and pairs with a companion handheld app.
...
with small description text underneath it (as illustrated above).
