...
The `text` variable can then be used to display the text or otherwise use it in code. The following screenshot shows the text rendered in a `Label` control:
